...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("carsusers");
}
...
class tDAL
{
	var $tblCars_at_localhost__carsbcolor;
	var $tblCars_at_localhost__carscars;
	var $tblCars_at_localhost__carscategory;
	var $tblCars_at_localhost__carsform;
	var $tblCars_at_localhost__carsmake;
	var $tblCars_at_localhost__carsmodels;
	var $tblCars_at_localhost__carsusers;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "carsbcolor", "varname" => "Cars_at_localhost__carsbcolor", "altvarname" => "carsbcolor", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carscars", "varname" => "Cars_at_localhost__carscars", "altvarname" => "carscars", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carscategory", "varname" => "Cars_at_localhost__carscategory", "altvarname" => "carscategory", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carsform", "varname" => "Cars_at_localhost__carsform", "altvarname" => "carsform", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carsmake", "varname" => "Cars_at_localhost__carsmake", "altvarname" => "carsmake", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carsmodels", "varname" => "Cars_at_localhost__carsmodels", "altvarname" => "carsmodels", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carsusers", "varname" => "Cars_at_localhost__carsusers", "altvarname" => "carsusers", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
	}
