...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="carscars" && $field=="Picture" && $ptype=="view")
	{
...
foreach($res as $val){
	$style = "";
		...
		$out.= "<li ".$style." data-src=\"".GetWebRootPath().$val["name"]."\" style=\"float:left;margin-right:10px\">".
				  "<a class=\"lgclass\" href=\"\">".
						"<img width=170px class=\"img-responsive\" src=\"".GetWebRootPath().$val["thumbnail"]."\">".
				  "</a></li>";
		//$first = false;
}
$value = "<div style=\"padding-left:10px;\">".
