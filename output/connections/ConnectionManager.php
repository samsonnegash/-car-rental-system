...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connectionString"] = "mysql;localhost;root;;;car;;1"; //currently unused
		...
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=car;OPTION=3";
		// encription set
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["carsusers"] = "Cars_at_localhost";
