...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("carscars" == $this->chrt_array['tables'][0])
			return true;
		if("carsmake" == $this->chrt_array['tables'][0])
			return true;
		if("carsmodels" == $this->chrt_array['tables'][0])
			return true;
		if("carsbcolor" == $this->chrt_array['tables'][0])
			return true;
		if("carscategory" == $this->chrt_array['tables'][0])
			return true;
		if("carsform" == $this->chrt_array['tables'][0])
			return true;
		if("carsusers" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
