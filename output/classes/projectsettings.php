...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("carsusers", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "carscars" ] = array( "url" => "carscars", "type" => 0 );
	$projectEntitiesReverse[ "carscars" ] = "carscars";
	$projectEntities[ "carsmake" ] = array( "url" => "carsmake", "type" => 0 );
	$projectEntitiesReverse[ "carsmake" ] = "carsmake";
	$projectEntities[ "carsmodels" ] = array( "url" => "carsmodels", "type" => 0 );
	$projectEntitiesReverse[ "carsmodels" ] = "carsmodels";
	$projectEntities[ "carsbcolor" ] = array( "url" => "carsbcolor", "type" => 0 );
	$projectEntitiesReverse[ "carsbcolor" ] = "carsbcolor";
	$projectEntities[ "carscategory" ] = array( "url" => "carscategory", "type" => 0 );
	$projectEntitiesReverse[ "carscategory" ] = "carscategory";
	$projectEntities[ "carsform" ] = array( "url" => "carsform", "type" => 0 );
	$projectEntitiesReverse[ "carsform" ] = "carsform";
	$projectEntities[ "carsusers" ] = array( "url" => "carsusers", "type" => 0 );
	$projectEntitiesReverse[ "carsusers" ] = "carsusers";
}
