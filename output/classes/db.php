...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "carsbcolor", "varname" => "Cars_at_localhost__carsbcolor", "altvarname" => "carsbcolor", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carscars", "varname" => "Cars_at_localhost__carscars", "altvarname" => "carscars", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carscategory", "varname" => "Cars_at_localhost__carscategory", "altvarname" => "carscategory", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carsform", "varname" => "Cars_at_localhost__carsform", "altvarname" => "carsform", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carsmake", "varname" => "Cars_at_localhost__carsmake", "altvarname" => "carsmake", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carsmodels", "varname" => "Cars_at_localhost__carsmodels", "altvarname" => "carsmodels", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carsusers", "varname" => "Cars_at_localhost__carsusers", "altvarname" => "carsusers", "connId" => "Cars_at_localhost", "schema" => "", "connName" => "Cars at localhost");
		}
	}
